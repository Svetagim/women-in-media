...
<form action="LoginServlet" method="post">
    ...
    <input autocomplete="false" type="password" name="password"/><br>
...
<form action="RegisterServlet" method="post">
    ...
    Please enter your lastname&nbsp
